...
import ua.a5.mybusinessplan.model.Note;
import ua.a5.mybusinessplan.utils.MyMovementMethod;

import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_NOTES_KEY_CATEGORY;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_NOTES_KEY_IMPORTANCE;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_NOTES_KEY_NOTETEXT;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_NOTES_KEY_TITLE;
...
////////////////////////
        ...
        btnCreateNoteNotesMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CreateNoteActivity.this, NotesMenuActivity.class);
