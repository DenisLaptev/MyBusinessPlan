...
import ua.a5.mybusinessplan.model.Event;

import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_BEGIN_DAY;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_BEGIN_HOUR;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_BEGIN_MINUTE;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_BEGIN_MONTH;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_DESCRIPTION;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_END_DAY;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_END_HOUR;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_END_MINUTE;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_END_MONTH;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_IMPORTANCE;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_LOCATION;
import static ua.a5.mybusinessplan.DAO.DBHelper.TABLE_EVENTS_KEY_TITLE;
...
////////////////////////
        ...
        btnCreateEventEventsMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CreateEventActivity.this, EventsMenuActivity.class);
